...
public class CoreMod {
  ...
  public static final RegistryDelegate<FloatConfigEntry> SHADER_ABERRATION_CONFIG = CONFIG_REGISTRAR.register("shader_aberration", () -> new FloatConfigEntry(0.1f, 0.01f, 0.05f, 0.0f, 0.4f, ConfigStorageLocation.GLOBAL, ConfigCategory.POSTPROCESSING));
  ...
  public static final RegistryDelegate<FloatConfigEntry> SHADER_BLOOM_INTENSITY_CONFIG = CONFIG_REGISTRAR.register("shader_bloom_intensity", () -> new FloatConfigEntry(0.0f, 0.01f, 0.1f, 0.0f, 3.0f, ConfigStorageLocation.GLOBAL, ConfigCategory.POSTPROCESSING));
  public static final RegistryDelegate<FloatConfigEntry> SHADER_BLOOM_THRESHOLD_CONFIG = CONFIG_REGISTRAR.register("shader_bloom_threshold", () -> new FloatConfigEntry(0.3f, 0.05f, 0.1f, 0.0f, 1.0f, ConfigStorageLocation.GLOBAL, ConfigCategory.POSTPROCESSING));
  public static final RegistryDelegate<FloatConfigEntry> SHADER_BLOOM_RADIUS_CONFIG = CONFIG_REGISTRAR.register("shader_bloom_radius", () -> new FloatConfigEntry(1.0f, 0.25f, 1.0f, 0.25f, 100.0f, ConfigStorageLocation.GLOBAL, ConfigCategory.POSTPROCESSING));
